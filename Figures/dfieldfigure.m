...
%     l = imrotate(l,-15,'crop');
    holes = loaddata(fpath,t,'covid_layers','int8')<1;
    
    im = real2rgb(dir,orientcmap,[-pi/2 pi/2]);
    fig = figure('Units','pixels','PaperUnits','points',...
        'Position',[0 0 512 384],'PaperPosition',[0 0 512 384],'PaperSize',[672 414]);
    
    ax = axes(fig,'Units','pixels','Position',[0 0 512 384],'LineWidth',2,...
